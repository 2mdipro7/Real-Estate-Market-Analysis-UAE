...
columns = ["Ad Type", "Agent Type", "Property Type", "Price (AED)", "Details", "Service Type", "Address", "Bedrooms", "Bathrooms", "Area (sqft)", "Listed on", "Agent Name", "Agent Position", "Total Properties", "Spoken Languages by Agent"]
...
def main():
    ...
    df.head(5000).to_csv("property_data2.csv", index=True)
    print("property_data2.csv")
