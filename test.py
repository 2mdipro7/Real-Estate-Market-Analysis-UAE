...
columns = ["Ad Type", "Agent Type", "Property Type", "Price", "Details", "Service Type", "Address", "Bedrooms", "Bathrooms", "Area (sqft)", "Listed on", "Agent Name", "Agent Position", "Total Properties", "Spoken Languages by Agent"]
...
def main():
    ...
    df.head(1000).to_csv("property_data1.csv", index=False)
